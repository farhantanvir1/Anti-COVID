...
class GNN(object):
    ...
    """
    def __init__(self, adj_matrix, features=None, labels=None, supervised=False, model='gat', n_layer=2, emb_size=64, random_state=1234, device='auto', epochs=2, batch_size=20, lr=0.7, unsup_loss_type='margin', print_progress=True):
...
class Classification(nn.Module):
    def __init__(self, emb_size, num_classes):
        ...
        self.fc1 = nn.Linear(emb_size, 32)
